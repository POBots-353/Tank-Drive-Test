...
public class Robot extends TimedRobot {
  ...
  private CANSparkMax backLeftMotor = new CANSparkMax(2, MotorType.kBrushless);
  private CANSparkMax backRightMotor = new CANSparkMax(3, MotorType.kBrushless);
  ...
  public void teleopPeriodic() {
    double leftY = controller.getLeftY() * 0.50;
    double rightY = controller.getRightY() * 0.50;

    differentialDrive.tankDrive(-leftLimiter.calculate(leftY), -rightLimiter.calculate(rightY));
  }
